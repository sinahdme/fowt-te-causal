...
1.  Download and install [Cygwin 64-bit](https://cygwin.com/setup-x86_64.exe). You will need to `Run as Administrator` to complete the installation process.
...
From here, pick up from the Linux with CMake instructions at `cmake_unix`.
