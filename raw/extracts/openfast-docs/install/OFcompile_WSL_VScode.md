...
> [!NOTE]
> Adapted from guide written by [skvibimigger](https://github.com/skvibimigger) in an issue comment: [OpenFAST Issue \#2904](https://github.com/OpenFAST/openfast/issues/2904#issuecomment-3056252458)
...
- For additional help, refer to the [OpenFAST GitHub repository](https://github.com/OpenFAST/openfast).
