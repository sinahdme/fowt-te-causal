...
Each visualization output file follows the same VTK format used for the ambient wind data files for the high-fidelity precursor simulations. See `FF:AmbWindIfW` for details on the file format.
