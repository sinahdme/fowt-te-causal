...
where, *MyDriverFile.dvr* is the name of the SubDyn driver file, as described in `sd_main-input-file`. The SubDyn primary input file is described in Section `sd_driver-input-file`.
